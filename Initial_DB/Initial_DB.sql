...
create or replace database SUPPLYCHAINDATA_DEMO COMMENT='This database holds the raw supply chain data.';




create or replace TABLE SUPPLYCHAINDATA_DEMO.PUBLIC.CATEGORY (
	CATEGORYID NUMBER(38,0),
	CATEGORYNAME VARCHAR(16777216)
);


create or replace TABLE SUPPLYCHAINDATA_DEMO.PUBLIC.CUSTOMER (
...
create or replace TABLE SUPPLYCHAINDATA_DEMO.PUBLIC.DEPARTMENT (
	DEPARTMENT_ID NUMBER(38,0),
	DEPARTMENT_NAME VARCHAR(50)
);


create or replace TABLE SUPPLYCHAINDATA_DEMO.PUBLIC.ORDER_INFO (
...
create or replace TABLE SUPPLYCHAINDATA_DEMO.PUBLIC.SHIPPING (
	ORDER_ID NUMBER(38,0),
	ORDER_ITEM_ID NUMBER(38,0),
...
create or replace TABLE SUPPLYCHAINDATA_DEMO.PUBLIC.STORE (
	STOREID NUMBER(32,0) autoincrement start 1 increment 1 order,
